...
different ways.
\textcolor{red}{What does `format' mean?  Is it referring to byte
  order, or to IEEE/VAX floats?  How about `\dots despite
  platform-specific details of byte-order and floating-point format.'?}
...
\end{verbatim}
\textcolor{red}{Explain tilde vs colon syntax}
...
to.  \textcolor{red}{And if the history structure does not exist?}
