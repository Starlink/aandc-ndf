...
values. \texttt{NaN} was excluded from the standard as it was not
...
until the 1990s \citep[e.g.,][]{1991STARB...8...11C}.

{\color{red} so it's interesting that FITS does support NaN in
  floating point data arrays, although not in FITS headers, despite
  FITS being developed on VAX. Is the issue here that floating point
  FITS came later?}
...
specify pixels and the third coordinate is a world coordinate range.
