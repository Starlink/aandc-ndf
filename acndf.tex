...
knows the semantics of FITS file to map FITS extensions to NDF
...
NaN values become the NDF bad value; the WCS headers are used to form
...
being being converted to a series of NDF extensions.  The HDS type of
