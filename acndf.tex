...
components. Various products from known sources are recognised from
keyword values. In the the case of a former NDF, the reader examines
...
the primary array and metadata is adequate for the conversion.  It's
