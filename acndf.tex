...
Demonstrated usability in many wavelength regimes that were not
involved in initial discussion.

\subsubsection{Standardised features aids application writers}



\subsubsection{Round-tripping to other data formats}

Can round-trip to and from FITS \citep[see e.g.][]{1997STARB..19...14C}
