...
the early-2000s NDX project (Sec.~\ref{sec:ndx}).  We believe this was a
...
As described above (Sec.~\ref{sec:more}), the NDF model includes a
...
(Sec.~\ref{sec:hds}).  Some applications treated this as a black box;
